...
def google():
	...
	GOOGLE_CLIENT_SECRET = params['app_key']
...
def twitter():
	...
	TWITTER_CLIENT_ID = '22423367'
	TWITTER_CLIENT_SECRET = 'dmSkBTBUdm8mmNo1bS9Ur4PaiiMUuvb3Lk8OjlXgMKxYl'
	oauth.register(
		name='twitter',
...
def facebook():
	...
	FACEBOOK_CLIENT_ID = '1534854630242128'
	FACEBOOK_CLIENT_SECRET = '975446d3f75d29c0d4bbddc77bee50db'
	oauth.register(
		name='facebook',
