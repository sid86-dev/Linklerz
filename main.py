...
def entry(username_get,userpass_encrypt):
    entry = Users(username=username_get, password=userpass_encrypt,  email="test@gmail.com", plan = 'free'
    , confirmation = 'NO', linktype="Facebook", linkurl="testurl"
     )
